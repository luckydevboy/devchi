...
//     }
//     return createPortal(<ReactQueryDevtoolsPanel client={client} />, container);
//   },
//   onDisable: () => {
//     console.log("onDisable ReactQueryDevtools5Plugin called");
...
export function createReactQueryDevtools5Plugin(): Plugin {
  ...
  function Wrapper({ client }: { client: any }) {
    ...
    setOpenState = setIsOpen; // allow outside control
